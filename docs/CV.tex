...
\address{Room 216, Puumiehenkuja 3, 02130 Espoo, Finland} % Your address
\address{ {\href{mailto:yanglang.yuan@aalto.fi}{\raisebox{-0.2\height}\faEnvelope\  {yanglang.yuan@aalto.fi}}}
...
% {\bf Aalto University} \hfill {\em July 2024 - Present} \\ 
% {PhD in Mechanical Engineering} \hfill {Espoo, Finland}
