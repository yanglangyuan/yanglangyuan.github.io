...
{MSc in Electronic Science and Technology} \hfill {Shenzhen, China}
...
%   \end{rSubsection}
    ...
    % \end{rSubsection}
       ...
       \item { \textbf{Yanglang Yuan}, Jiahui Zhang, Xiaoyu Zhang, Fan Zhou, Yajun Wang, Hui Li, Haijiang Wang. (2019) “Fuel cell bipolar plate and fuel cell". \textit{CN (Patent) CN110459780A, filed, Nov.15,2019.}}
       \vspace{2pt}
       
       \item { \textbf{Yanglang Yuan}, Jiahui Zhang, Xiaoyu Zhang, Fan Zhou, Yajun Wang, Hui Li, Haijiang Wang. (2019) “Fuel cell bipolar plate and fuel cell". \textit{CN (Patent) CN210429963U, filed July 25,2019.}}
...
\begin{rSection}{Research Experience}
    ...
    \begin{rSubsection}{Intelligent Manufacturing Lab at SUSTech}{July 2021 - Present}{Advisor: Prof. Kevin Yiming Rong}{Shenzhen, China}
    \vspace{-4pt}
 ...
 %   Built hexapod robot model in Webots simulator and developed a tripod gait controller;\\
  %  Designed experiments to derive the leg-terrain interaction model based on Resistive Force Theory;\\
   % Proposed a way to reduce the overlapping time of stance for different gaits and minimize the sinkage.
    ...
    \begin{rSubsection}{Formula Student Electric China Program}{2016 - 2017}{Advisor: Professor Kevin Yiming Rong}{Shenzhen,China}
        \vspace{-4pt}
...
Certificate & GCDF \\
Programming & Proficient: MATLAB, Python;   ~~Intermediate: C/C++, Java \\
...
\begin{rSection}{Honors and Awards}
    \vspace{-8pt}
    \item {Excellent Teaching Assistant, Graduate School of SUSTech}   \hfill {2022}  
     \vspace{-5pt}
